...
public class RobotContainer {
    ...
    private void configureBindings() {
        ...
        ButtonBoard.Button7().onTrue(Intake.INTAKE());
        ButtonBoard.Button7().onFalse(Intake.IDLE());
        drivetrain.setDefaultCommand(
                // Drivetrain will execute this command periodically
                drivetrain.applyRequest(() -> robot.withVelocityX(-joystick.getLeftY() * MaxSpeed) // Drive forward with
                                                                                                   // negative Y
                                                                                                   // (forward)
