...
public class fuelintake extends SubsystemBase {
  ...
  public fuelintake(int RollerID, int PivotID, int INTAKECANID) {
    ...
    IntakeRoller.configure(new SparkMaxConfig(), ResetMode.kNoResetSafeParameters, PersistMode.kPersistParameters);
    CanCode = new CANcoder(INTAKECANID);
  ...
  private void motorconfig() {
    ...
    var cancodeConfig = new CANcoderConfiguration();

    //offset
    cancodeConfig.MagnetSensor.MagnetOffset = 0;
